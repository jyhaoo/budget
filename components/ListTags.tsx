...
import useCustomSupabaseClient from "@/hooks/useCustomSupabaseClient";
  ...
  return (
    <>
      {isSelectTag && (
        ...
        >
          <div className="h-screen w-lg mx-auto bg-white dark:bg-black bg-opacity-60 backdrop-blur-sm" />
        </div>
      )}
      <motion.div
        initial={false}
      ...
      >
        ...
        <div className="w-full grid grid-cols-4 gap-y-5">
          <div
            className="rounded-full border w-14 h-14 mx-auto flex justify-center items-center items-center cursor-pointer group hover:border-zinc-500 transition-all"
      ...
      >
        <div className="border-b dark:border-sinc-600">
          <BsArrowLeftShort
            className="w-8 h-8"
