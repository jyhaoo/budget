...
export default function AddExpense() {
  return (
    <>
      <div className="fixed bottom-0 h-screen w-full sm:w-lg bg-white dark:bg-black p-5 bg-opacity-90 backdrop-blur-sm">
        <div
        ...
        >
          <div className="flex">
            <div>
              <h1 className="text-center text-sm text-gray-400">Today</h1>
              <input
          ...
          <div className="flex cursor-pointer hover:tracking-wider transition-all items-center">
