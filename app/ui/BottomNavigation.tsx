...
export default function BottomNaviation() {
  return (
    <div className="fixed bottom-0 w-lg h-18 grid grid-cols-3 bg-white dark:bg-black px-8 sm:px-0 pb-5 z-10 dark:border-sinz-600">
      <button>
        <div className="flex justify-center items-center flex-col group cursor-pointer">
          <div
            className={cn(
              "flex items-center flex-col justify-center text-gray-500 dakr:Text-gray-400"
            )}
          >
